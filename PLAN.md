...
- [ ] Build and activate source commit `b2b8cce` so initial badges contain valid JSON bytes. Curiosity poke: parse every served seed with `jq`, not merely inspect its source text.
