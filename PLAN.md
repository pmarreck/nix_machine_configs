...
- [x] Vendor the receiver, repository policy, worker, and scripts from source commit `13870e9`.
- [x] Add an executable provenance check for the vendored boundary.
- [x] Build the scoped NixOS revision from clean committed-tree isolation. Completed 2026-07-10 12:07 EDT.
